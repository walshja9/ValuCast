...
**Status:** open R&D. Foundation work (A/A+ level support) is on branch
`claude/action-completion-date-bug-kqk5pa`. Data artifacts are intentionally
NOT regenerated here — regenerate them as you iterate (see Evaluation harness).
