...
This spent result is invalid for adjudication and descriptive only. The machine-readable correction `data/validation/valucast_prospect_normalized_production_adjudication.json` binds the sealed source content SHA-256 `49116e4e7bb5773fa981fa0096a6a15fad72fd5c1c02aa2236a6dce9ad2be19a` and source-file SHA-256 `9b0f9e2ff49af88cd7e48b609788f73cba3bbc9b39860af409d7593ea496af70`; it records all three invalidations with `rerun_authorized`, `claim_authorized`, and `public_claim_eligible` false. It does not change the live model, Rank v1, any served artifact, or any production workflow, and it authorizes no public superiority claim.
